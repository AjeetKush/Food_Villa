        ...
        <div className="res-card m-4 p-4 w-[250px] bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
            ...
            <div className="flex justify-between items-center mt-2">
                <div className="flex items-center">
                    ...
                    {avgRating >= 4.3 && <span className="text-gray-600">High Rating!</span>}
                </div>
...
// Enhance RestaurantCard with a High Rating label (only for cards with a rating of 4.3 or more)
export const withHighRating = (WrappedComponent) => {
    return (props) => {
        return (
            <div className="relative">
                {props.resData.info.avgRating >= 4.3 && (
                    <label className="absolute bg-black text-white m-1 p-1 rounded-lg">High Rating!</label>
                )}

                {/* Render the enhanced RestaurantCard */}
